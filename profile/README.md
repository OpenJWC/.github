...
├── 快速开始.md                        # 部署运行指南
├── 源代码/                           # 源代码目录
│   ├── OpenJWC-Server/              # Docker部署编排
│   ├── OpenJWC-webapi/              # 后端API服务
│   ├── JwcCrawler/                  # 爬虫引擎
│   ├── OpenJWC-web-frontend/        # Web管理面板
│   ├── OpenJWCClient/               # Android客户端
│   └── openjwc-qqbot/               # QQ机器人
├── 文档/                            # 详细文档
│   ├── API文档.md                    # API接口文档
│   ├── 开发指南.md                    # 开发者指南
...
2. **配置环境变量**
   编辑 `docker-compose.yml` 中的环境变量配置
...
- **个性化推送**: 订阅感兴趣的内容类型，获取定制化通知
- **离线阅读**: 支持离线缓存，无网络时也能浏览已下载内容
